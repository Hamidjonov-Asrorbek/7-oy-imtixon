            ...
            <div className="flex flex-wrap gap-5 mt-5">
              {state.filterData.map((item) => {
                ...
                return (
                  <div
                    key={id}
                    className="card card-compact text-center w-72 bg-base-100 shadow-sm shadow-white"
                  >
                    ...
                    <div className="card-body box-border text-center">
                      <h2 className="card-title text-center m-auto">{title}</h2>
                      {/* <p>{description}</p> */}
                      <p>{price} $</p>
                      {/* <p>Rating: {rating}⭐</p> */}
